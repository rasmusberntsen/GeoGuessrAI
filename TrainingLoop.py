...
class Optimization:
    ...
    def train_step(self, x, y):
        ...
        # Forward pass
        y_pred = self.model(x)
        y_pred = y_pred.view(-1, 1) # Måske skal det her ændres
        # Compute Loss
    ...
    def train(self, train_loader, val_loader, epochs):
        for epoch in range(epochs):
            ...
            for x_batch, y_batch in train_loader:
                ...
                x_batch = x_batch.view([b_size, -1, 1]).to(device) # noget her der skal ændres
            ...
            with torch.no_grad():
                ...
                for x_val, y_val in val_loader:
                    b_size = x_val.size(0)
                    x_val = x_val.view([b_size, -1, 1]).to(device) # noget her der skal ændres
