...
if __name__ == "__main__":
    ...
    p1.start()
    p2 = Process(target=image_getter, args=("ee",))
    p2.start()
    p3 = Process(target=image_getter, args=("ee",))
    p3.start()
    p4 = Process(target=image_getter, args=("ee",))
    p4.start()
    p5 = Process(target=image_getter, args=("ee",))
    p5.start()
    p6 = Process(target=image_getter, args=("ee",))
    p6.start()
    p7 = Process(target=image_getter, args=("ee",))
    p7.start()
    p8 = Process(target=image_getter, args=("ee",))
    p8.start()
    p9 = Process(target=image_getter, args=("ee",))
    p9.start()
    p10 = Process(target=image_getter, args=("ee",))
    p10.start()
